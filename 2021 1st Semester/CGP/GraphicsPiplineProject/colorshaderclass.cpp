...
void ColorShaderClass::ColorBrightnessChanger(ID3D11Device* device, char ch) {
	ID3D10Blob* pixelShaderBuffer;
	if(ch == '2')
		D3DX11CompileFromFile(L"color.ps", NULL, NULL, "ColorPixelShaderH", "ps_5_0", 
			D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL, &pixelShaderBuffer, NULL, NULL);
	else
		D3DX11CompileFromFile(L"color.ps", NULL, NULL, "ColorPixelShader", "ps_5_0",
			D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL, &pixelShaderBuffer, NULL, NULL);
